...
def range_and_bearing(objects, global_memory):
    ...
    #dobjects = dd.from_pandas(objects, npartitions=os.cpu_count())
    #input_dobjects = dobjects[["type", "x", "y", "v", "w", "heading", "level", "fault", "gossip", "communication_radius"]]
    #dobjects["range_and_bearing"] = input_dobjects.apply(rnb_fn, axis=1, meta=("range_and_bearing", "object"))
    #return dobjects.compute()
